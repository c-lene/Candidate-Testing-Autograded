...
function askForName() {
  ...
  candidateName = input.question("Hello there! What is your name? ")
...
function gradeQuiz(candidateAnswers) {
  ...
  /*if (candidateAnswer === correctAnswer) {                      // This was code from 'Task 1' - CT
...
function runProgram() {
  ...
  // TODO 1.1c: Greet candidate using their name //
   console.log("Welcome to our quiz, " + candidateName + "!");
  askQuestion();
